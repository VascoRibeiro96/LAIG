...
MySceneGraph.prototype.parseScene= function(rootElement) {
	...
	console.log("Scene read from file: {background=" + this.background + ", drawmode=" + this.drawmode + ", cullface=" + this.cullface + ", cullorder=" + this.cullorder + "}");
...
MySceneGraph.prototype.parseIlumination= function (illumination) {
